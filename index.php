<?php get_header(); ?>
    ...
    <section class="card">
        ...
        <div class="bio">
            ...
            and reliability with run-time efficiency.<br/><br/>
            </span>
            <ul class="icons">
				<li>
    ...
    <section class="projects">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <a class="img-responsive text-center" href='https://github.com/mohd-ahsan-mirza/aws-projects'><i class="fab fa-aws fa-5x"></i></a>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12">
    ...
    <section class="recommendations">
        ...
        <div id="carousel-recommendations" class="carousel slide" data-ride="carousel" data-interval="1500">
