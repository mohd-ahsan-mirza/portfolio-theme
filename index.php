<?php get_header(); ?>
    ...
    <section class="card">
        ...
        <div class="bio">
            ...
            <ul class="icons">
				<li class="col-lg-6 col-md-6 col-sm-6"><a class="float-right" href='https://ca.linkedin.com/in/muhammad-ahsan-mirza-460b6378' class="icon round fa-linkedin"><span class="label">LinkedIn</span></a></li>
